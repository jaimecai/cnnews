                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">修改新闻  ${newsInfo.news.id}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="/admin/NewsServlet.action?method=edit" method="post"
                              enctype="multipart/form-data">
                            <input type="hidden" name="oldPicture" value="${newsInfo.news.picture}">
                            <input type="hidden" name="newsId" value="${newsInfo.news.id}">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="browsercount" name="browsercount"
                                               value="${newsInfo.news.browserCount}" placeholder="默认为0">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control select2" style="width: 100%" name="newsTypeId">
                                            <c:forEach items="${newsTypes}" var="item">
                                                <option ${item.id==newsInfo.news.id?"selected":""}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" class="flat-red" name="isPicture">
                                                是否修改图片
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-5 col-sm-offset-2">
                                        <img id="selectPictureView" width="200px" height="200px"
                                             src="/upload/cnnews/${newsInfo.news.picture}">
                                    </div>
                                </div>
                                <div class="form-group">
